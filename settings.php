<?php
	$adresa="7700 Tamiami Trail North Suite #103 Naples, FL 34108 USA"; //jako je vazno navesti dobro adresu radi boljeg poziciniranja
	$grad="";//jako je vazno ako adresa ima dva imena povezati ih sa plus
	$skracenica=""; // AKo ne znate skracenicu ostavite praznu
	$telephone=2395148700 ;// Broj koji se poziva na dugme CALL US
